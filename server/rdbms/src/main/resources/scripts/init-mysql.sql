...
CREATE TABLE `t_answer` (
  ...
  `exam_info` text COLLATE utf8mb4_bin COMMENT '考试信息',
...
CREATE TABLE `t_dashboard` (
  ...
  `update_by` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='仪表盘';
...
CREATE TABLE `t_flow_entry` (
  ...
  `process_definition_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '流程定义 id',
  `deploy_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '部署id',
  `bpmn_xml` longtext COLLATE utf8mb4_bin COMMENT '流程XML',
  `nodes` longtext COLLATE utf8mb4_bin COMMENT '流程节点',
  `icon` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '流程图标',
  ...
  `update_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='流程实体';
...
CREATE TABLE `t_flow_entry_node` (
  ...
  `field_permission` text COLLATE utf8mb4_bin COMMENT '字段权限',
  `setting` text COLLATE utf8mb4_bin COMMENT '流程设置',
  `identity` text COLLATE utf8mb4_bin COMMENT '授权用户',
  `expression` text COLLATE utf8mb4_bin COMMENT '表达式',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='流程节点';
...
CREATE TABLE `t_flow_instance` (
  ...
  `project_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '项目id',
  `answer_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '答案id',
  `status` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '当前状态',
  `approval_stage` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '审批阶段',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `t_flow_operation` (
  ...
  `project_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '项目id',
  `answer_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '答案id',
  `activity_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '任务对应的xml节点id',
  ...
  `approval_type` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '审批类型',
  `comment` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '注释内容',
  `delegate_assignee` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '委托指定人',
  `answer` varchar(1024) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '当前节点答案',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `new_activity_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '新的任务节点id',
  `latest` bit(1) DEFAULT NULL COMMENT '当前流程最新操作',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='流程操作';
...
CREATE TABLE `t_flow_operation_user` (
  ...
  `group_id` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '组id',
  `link_type` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户类型',
  `latest` bit(1) NOT NULL DEFAULT b'1' COMMENT '是否最新记录',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `t_project` (
  ...
  `setting` text COLLATE utf8mb4_bin DEFAULT NULL COMMENT '问卷设置',
  `status` int(11) DEFAULT '0' COMMENT '0未发布 1已发布',
  `belong_group` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `mode` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '问卷模式',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `t_project_partner` (
  ...
  `user_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '参与者id',
  `group_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '参与组id',
  `data_permission` text COLLATE utf8mb4_bin COMMENT '数据权限',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `t_sys_info` (
  ...
  `description` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '系统描述信息',
  `avatar` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '图标',
  `locale` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '默认语言',
  `version` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '默认语言',
  `register_info` varchar(1024) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '注册信息',
...
CREATE TABLE `t_user` (
  ...
  `update_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(256) DEFAULT NULL,
  `profile` varbinary(255) DEFAULT NULL COMMENT '个人简介',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_user_position` (
  ...
  `update_by` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户岗位';
