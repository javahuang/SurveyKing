...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse<String>> handleNotFoundException(HttpServletRequest request,
			NotFoundException ex) {
		log.error("NotFoundException {}\n", request.getRequestURI(), ex);

		return ResponseEntity.ok().body(new ApiResponse<>(ResponseCode.FAIL.code, "Not found exception"));
	}
	...
	public ResponseEntity<ApiResponse<String>> handleInternalServerError(HttpServletRequest request, Exception ex) {
		...
		return ResponseEntity.ok().body(
				new ApiResponse<>(ResponseCode.INTERNAL_SERVER_ERROR.code, "Internal server error " + ex.getMessage()));
	}
